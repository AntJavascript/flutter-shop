...
OrderList _$OrderListFromJson(Map<String, dynamic> json) {
  return new OrderList(
      ...
      (json['data'] as List)
          ?.map((e) => e == null
              ? null
              : new OrderListData.fromJson(e as Map<String, dynamic>))
          ?.toList(),
      json['total'] as int);
}

abstract class _$OrderListSerializerMixin {
  int get code;
  List<OrderListData> get data;
  int get total;
...
abstract class _$OrderListDataSerializerMixin {
  Order get order;
...
Order _$OrderFromJson(Map<String, dynamic> json) {
  return new Order(
      ...
      json['CouponAmount'] as int,
      json['Phone'] as String,
      json['Name'] as String,
      json['Address'] as String,
      json['PayType'] as int,
      json['FreightAmount'] as int,
