...
@JsonSerializable()
  class OrderDetail extends Object with _$OrderDetailSerializerMixin{
  ...
  OrderDetail(this.code,this.data,this.msg,);
...
@JsonSerializable()
  class OrderDetailData extends Object with _$OrderDetailDataSerializerMixin{
  ...
  OrderDetailData(this.order,this.productList,this.cartList,this.productSpecsList,);
